import svgPaths from "./svg-psldbqyy2a";
...
function HeaderTopNavBarAuthorityJson() {
  return (
    <div className="backdrop-blur-[6px] bg-[rgba(251,248,255,0.8)] content-stretch flex h-[64px] items-center justify-between pb-px px-[32px] relative shrink-0 w-[1024px]" data-name="Header - TopNavBar (Authority: JSON)">
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[32px] tracking-[-0.32px] whitespace-nowrap">
        <p className="leading-[40px]">Audit Logs</p>
      </div>
    </div>
  );
}
...
function Container22() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[672px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
        <p className="leading-[24px] mb-0">An immutable ledger recording every administrative and transactional event across the</p>
        <p className="leading-[24px] mb-0">PerfektWerk ecosystem. Records are cryptographically hashed and cannot be altered or</p>
        <p className="leading-[24px]">deleted.</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[666.67px]" data-name="Container">
      <Heading1 />
      <Container22 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[12px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="12" preserveAspectRatio="none" viewBox="0 0 12 12" width="12">
        <g id="Container">
          <path d={svgPaths.p117df680} fill="var(--fill-0, white)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button5() {
  return (
    <div className="bg-[#003ec7] content-stretch drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] flex gap-[8px] items-center px-[16px] py-[9px] relative rounded-[8px] shrink-0" data-name="Button">
      <Container24 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
        <p className="leading-[24px]">Refresh Ledger</p>
      </div>
    </div>
  );
}
...
function SectionPageHeader() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Section - Page Header">
      <Container21 />
      <Container23 />
    </div>
  );
...
function Cell() {
  return (
    <div className="relative shrink-0 w-[151.84px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
          <p className="leading-[24px]">TIMESTAMP</p>
        </div>
      </div>
    </div>
  );
...
function Cell1() {
  return (
    <div className="relative shrink-0 w-[268.11px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
...
function Cell2() {
  return (
    <div className="relative shrink-0 w-[166.64px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
...
function Cell3() {
  return (
    <div className="relative shrink-0 w-[172.58px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
...
function Cell4() {
  return (
    <div className="relative shrink-0 w-[256.92px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
...
function Cell5() {
  return (
    <div className="relative shrink-0 w-[146.53px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] tracking-[0.8px] uppercase whitespace-nowrap">
...
function Cell6() {
  return (
    <div className="relative shrink-0 w-[120.09px]" data-name="Cell">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-end px-[24px] py-[16px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] text-right tracking-[0.8px] uppercase whitespace-nowrap">
...
function HeaderRow() {
  return (
    <div className="bg-[#f3f2ff] content-stretch flex items-start justify-center mb-[-1px] pb-px relative shrink-0 w-full" data-name="Header → Row">
...
function Container26() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] w-full">
        <p className="leading-[24px]">Oct 19, 2023</p>
      </div>
    </div>
  );
}
...
function Container27() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] w-full">
        <p className="leading-[24px]">14:22:15 UTC</p>
      </div>
    </div>
  );
}
...
function Overlay() {
  return (
    <div className="bg-[rgba(0,82,255,0.2)] content-stretch flex items-center justify-center pb-[7.5px] pt-[6.5px] relative rounded-[9999px] shrink-0 size-[32px]" data-name="Overlay">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#003ec7] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[18px]">MA</p>
      </div>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Marcus Aurelius</p>
      </div>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">m.aurelius@perfekt.io</p>
      </div>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[165.55px]" data-name="Container">
      <Container29 />
      <Container30 />
    </div>
  );
...
function Data1() {
  return (
    <div className="content-stretch flex gap-[12px] items-center pl-[24px] relative shrink-0 w-[244.11px]" data-name="Data">
      <Overlay />
      <Container28 />
    </div>
  );
...
function Data2() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[48px] pr-[24px] py-[28.5px] relative shrink-0 w-[190.64px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">System Admin</p>
      </div>
    </div>
  );
}
...
function BackgroundBorder1() {
  return (
    <div className="bg-[#eff6ff] content-stretch flex items-start px-[9px] py-[3.5px] relative rounded-[4px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#dbeafe] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#1d4ed8] text-[11px] tracking-[-0.275px] uppercase whitespace-nowrap">
        <p className="leading-[16.5px]">AUTHENTICATION</p>
      </div>
    </div>
  );
}
...
function Data3() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[26.5px] pt-[30.5px] px-[24px] relative shrink-0 w-[172.58px]" data-name="Data">
      <BackgroundBorder1 />
    </div>
  );
}
...
function Data4() {
  return (
    <div className="content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative shrink-0 w-[256.92px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
...
function Container32() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#16a34a] text-[16px] uppercase whitespace-nowrap">
...
function Data5() {
  return (
    <div className="content-stretch flex gap-[6px] items-center pl-[24px] relative shrink-0 w-[122.53px]" data-name="Data">
      <Container31 />
      <Container32 />
    </div>
  );
  ...
  return (
    <div className="h-[10px] relative shrink-0 w-[16.667px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="10" preserveAspectRatio="none" viewBox="0 0 16.6667 10" width="16.6667">
        <g id="Container">
          <path d={svgPaths.p2f0731c0} fill="var(--fill-0, #191B25)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button6() {
  return (
    <div className="content-stretch flex items-center justify-center pb-[8.37px] pt-[11.63px] px-[8px] relative rounded-[8px] shrink-0" data-name="Button">
      <Container33 />
    </div>
  );
}
...
function Data6() {
  return (
    <div className="content-stretch flex flex-col items-end pl-[48.01px] pr-[24px] py-[20.5px] relative shrink-0 w-[144.1px]" data-name="Data">
      <Button6 />
    </div>
  );
}
...
function Row1Auth() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Row 1: Auth">
      <Data />
      <Data1 />
      <Data2 />
      <Data3 />
...
function Container35() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] w-full">
        <p className="leading-[24px]">13:05:42 UTC</p>
      </div>
    </div>
  );
}
...
function Overlay1() {
  return (
    <div className="bg-[rgba(208,225,251,0.2)] content-stretch flex items-center justify-center pb-[7.5px] pt-[6.5px] relative rounded-[9999px] shrink-0 size-[32px]" data-name="Overlay">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[18px]">EF</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Elena Fisher</p>
      </div>
    </div>
  );
}
...
function Container38() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">e.fisher@perfekt.io</p>
      </div>
    </div>
  );
}
...
function Container36() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[144.72px]" data-name="Container">
      <Container37 />
      <Container38 />
    </div>
  );
...
function Data8() {
  return (
    <div className="relative shrink-0 w-[244.11px]" data-name="Data">
...
function Data9() {
  return (
    <div className="relative shrink-0 w-[190.64px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[48px] pr-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Bauwerk Group</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder2() {
  return (
    <div className="bg-[#faf5ff] content-stretch flex items-start px-[9px] py-[3.5px] relative rounded-[4px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#f3e8ff] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#7e22ce] text-[11px] tracking-[-0.275px] uppercase whitespace-nowrap">
        <p className="leading-[16.5px]">COMPANY ACTIONS</p>
      </div>
    </div>
  );
}
...
function Data10() {
  return (
    <div className="relative shrink-0 w-[172.58px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[26.5px] pt-[30.5px] px-[24px] relative size-full">
        <BackgroundBorder2 />
      </div>
    </div>
  );
...
function Data11() {
  return (
    <div className="relative shrink-0 w-[256.92px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Activated</p>
        </div>
      </div>
    </div>
  );
...
function Data12() {
  return (
    <div className="relative shrink-0 w-[122.53px]" data-name="Data">
...
function Data13() {
  return (
    <div className="relative shrink-0 w-[144.1px]" data-name="Data">
...
function Row2Company() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] pt-px relative shrink-0 w-full" data-name="Row 2: Company">
...
function Container43() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] w-full">
        <p className="leading-[24px]">11:45:00 UTC</p>
      </div>
    </div>
  );
}
...
function Data15() {
  return (
    <div className="relative shrink-0 w-[268.11px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Italic',sans-serif] font-normal italic justify-center leading-[0] relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">System Process (Automated)</p>
        </div>
      </div>
    </div>
  );
...
function Data16() {
  return (
    <div className="relative shrink-0 w-[166.64px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Stark Industries</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder3() {
  return (
    <div className="bg-[#f0fdf4] content-stretch flex items-start px-[9px] py-[3.5px] relative rounded-[4px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#dcfce7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#15803d] text-[11px] tracking-[-0.275px] uppercase whitespace-nowrap">
        <p className="leading-[16.5px]">BILLING</p>
      </div>
    </div>
  );
}
...
function Data18() {
  return (
    <div className="relative shrink-0 w-[256.92px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Invoice Generated</p>
        </div>
      </div>
    </div>
  );
...
function Row3Billing() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] pt-px relative shrink-0 w-full" data-name="Row 3: Billing">
      <div aria-hidden className="absolute border-[#c3c5d9] border-solid border-t inset-0 pointer-events-none" />
      <Data14 />
      <Data15 />
      <Data16 />
...
function Container48() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] w-full">
        <p className="leading-[24px]">09:12:33 UTC</p>
      </div>
    </div>
  );
}
...
function Overlay2() {
  return (
    <div className="bg-[rgba(255,218,214,0.2)] content-stretch flex items-center justify-center pb-[7.5px] pt-[6.5px] relative rounded-[9999px] shrink-0 size-[32px]" data-name="Overlay">
...
function Container50() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">Nathan Smith</p>
      </div>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
        <p className="leading-[24px]">n.smith@perfekt.io</p>
      </div>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[142.83px]" data-name="Container">
      <Container50 />
      <Container51 />
    </div>
  );
...
function Data23() {
  return (
    <div className="relative shrink-0 w-[190.64px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[48px] pr-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">System Config</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder4() {
  return (
    <div className="bg-[#fffbeb] content-stretch flex items-start px-[9px] py-[3.5px] relative rounded-[4px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#fef3c7] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#b45309] text-[11px] tracking-[-0.275px] uppercase whitespace-nowrap">
        <p className="leading-[16.5px]">CONFIGURATION</p>
      </div>
    </div>
  );
}
...
function Data25() {
  return (
    <div className="relative shrink-0 w-[256.92px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start px-[24px] py-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Feature Enabled (AI-Assist)</p>
        </div>
      </div>
    </div>
  );
...
function Container52() {
  return (
    <div className="relative shrink-0 size-[13.333px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="13.3333" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333" width="13.3333">
        <g id="Container">
          <path d={svgPaths.p7980b80} fill="var(--fill-0, #BA1A1A)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container53() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#ba1a1a] text-[16px] uppercase whitespace-nowrap">
        <p className="leading-[24px]">FAILURE</p>
      </div>
    </div>
  );
}
...
function Row4ConfigWarning() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] pt-px relative shrink-0 w-full" data-name="Row 4: Config - Warning">
      <div aria-hidden className="absolute border-[#c3c5d9] border-solid border-t inset-0 pointer-events-none" />
      <Data21 />
      <Data22 />
      <Data23 />
...
function Container56() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] w-full">
        <p className="leading-[24px]">08:00:12 UTC</p>
      </div>
    </div>
  );
}
...
function Data30() {
  return (
    <div className="relative shrink-0 w-[190.64px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[28px] pl-[48px] pr-[24px] pt-[28.5px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Global Support</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder5() {
  return (
    <div className="bg-[#f0fdfa] content-stretch flex items-start px-[9px] py-[3.5px] relative rounded-[4px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#ccfbf1] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0f766e] text-[11px] tracking-[-0.275px] uppercase whitespace-nowrap">
...
function Data31() {
  return (
    <div className="relative shrink-0 w-[172.58px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[26px] pt-[30.5px] px-[24px] relative size-full">
        <BackgroundBorder5 />
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-[256.92px]" data-name="Data">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pb-[28px] pt-[28.5px] px-[24px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] whitespace-nowrap">
          <p className="leading-[24px]">Ticket Created</p>
        </div>
      </div>
    </div>
  );
...
function Row5Support() {
  return (
    <div className="content-stretch flex items-center justify-center pt-px relative shrink-0 w-full" data-name="Row 5: Support">
      <div aria-hidden className="absolute border-[#c3c5d9] border-solid border-t inset-0 pointer-events-none" />
      <Data28 />
      <Data29 />
      <Data30 />
...
function Table() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1282.72px]" data-name="Table">
      <HeaderRow />
      <Body />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#505f76] text-[16px] whitespace-nowrap">
          <p>
            <span className="leading-[24px]">{`Showing `}</span>
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic text-[#191b25]">1 - 50</span>
            <span className="leading-[24px]">{` of 12,842 logs`}</span>
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="h-[9px] relative shrink-0 w-[5.55px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="9" preserveAspectRatio="none" viewBox="0 0 5.55 9" width="5.55">
        <g id="Container">
          <path d={svgPaths.p1250fe00} fill="var(--fill-0, #191B25)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button11() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center opacity-50 pb-[10.37px] pt-[13.63px] px-[9px] relative rounded-[8px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#c3c5d9] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container65 />
    </div>
  );
...
function Button12() {
  return (
    <div className="bg-[#003ec7] content-stretch flex flex-col items-center justify-center px-[12px] py-[6px] relative rounded-[8px] shrink-0" data-name="Button">
...
function Button13() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[12px] py-[6px] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] text-center whitespace-nowrap">
...
function Button15() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[12px] py-[6px] relative rounded-[8px] shrink-0" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[16px] text-center whitespace-nowrap">
        <p className="leading-[24px]">257</p>
      </div>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="h-[9px] relative shrink-0 w-[5.55px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="9" preserveAspectRatio="none" viewBox="0 0 5.55 9" width="5.55">
        <g id="Container">
          <path d={svgPaths.p4874b00} fill="var(--fill-0, #191B25)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button16() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pb-[10.37px] pt-[13.63px] px-[9px] relative rounded-[8px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#c3c5d9] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <Container67 />
    </div>
  );
...
function Pagination() {
  return (
    <div className="bg-[#f3f2ff] relative shrink-0 w-full" data-name="Pagination">
      <div aria-hidden className="absolute border-[#c3c5d9] border-solid border-t inset-0 pointer-events-none" />
...
function SectionAuditTable() {
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full" data-name="Section - Audit Table">
...
function ContentCanvasFixed1280PxContainerConstraint() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full z-[1]" data-name="Content Canvas (Fixed 1280px container constraint)">
...
function MainContentArea() {
  return (
    <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-name="Main Content Area">
      <ContentCanvasFixed1280PxContainerConstraint />
    </div>
  );
}
...
function AsideSideNavigationShell() {
  return (
    <div className="absolute bg-[#fbf8ff] content-stretch flex flex-col h-[1154px] items-start justify-between left-0 pl-[16px] pr-[17px] py-[8px] top-0 w-[256px]" data-name="Aside - Side Navigation Shell">
...
export default function Audit() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[256px] relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(251, 248, 255) 0%, rgb(251, 248, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="audit">
