import svgPaths from "./svg-2d1zsi48eq";
...
function Container12() {
  return (
    <div className="h-[18px] relative shrink-0 w-[20px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 20 18" width="20">
        <g id="Container">
          <path d={svgPaths.p20cc9b00} fill="var(--fill-0, #003EC7)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Nav() {
  return (
    <div className="h-[847px] relative shrink-0 w-full" data-name="Nav">
...
function AsideSideNavigationShell() {
  return (
    <div className="absolute bg-[#fbf8ff] content-stretch flex flex-col h-[1024px] items-start left-0 pl-[16px] pr-[17px] py-[8px] top-0 w-[256px]" data-name="Aside - Side Navigation Shell">
...
function Container36() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[12px] tracking-[0.6px] whitespace-nowrap">
...
function Container37() {
  return (
    <div className="h-[6px] relative shrink-0 w-[3.7px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="6" preserveAspectRatio="none" viewBox="0 0 3.7 6" width="3.7">
        <g id="Container">
          <path d={svgPaths.p2dcc20c0} fill="var(--fill-0, #434656)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container38() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#003ec7] text-[12px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[16px]">Environment Setup Guides</p>
      </div>
    </div>
  );
}
...
function Nav1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[16px] items-center relative shrink-0 w-[632.83px]" data-name="Nav">
      <Container36 />
      <Container37 />
      <Container38 />
    </div>
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[32px] tracking-[-0.8px] whitespace-nowrap">
        <p className="leading-[40px]">Enterprise FAQ Editor</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start max-w-[672px] relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[16px] whitespace-nowrap">
        <p className="leading-[24px] mb-0">Manage your global knowledge repository. Updates are reflected across all customer</p>
        <p className="leading-[24px]">touchpoints in real-time.</p>
      </div>
    </div>
  );
}
...
function Container39() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[642.44px]" data-name="Container">
      <Heading1 />
      <Container40 />
    </div>
  );
...
function Button2() {
  return (
    <div className="bg-[#003ec7] content-stretch flex gap-[7.99px] items-center px-[24px] py-[12px] relative rounded-[12px] shrink-0" data-name="Button">
      <div className="absolute bg-[rgba(255,255,255,0)] inset-[0_-0.03px_0_0] rounded-[12px] shadow-[0px_4px_6px_-1px_rgba(0,62,199,0.1),0px_2px_4px_-2px_rgba(0,62,199,0.1)]" data-name="Button:shadow" />
      <Container41 />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-white tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[16px]">Add New Question</p>
      </div>
    </div>
  );
}
...
function Container43() {
  return <div className="h-[10.667px] relative shrink-0 w-[14.667px]" data-name="Container" />;
}
...
function Heading3() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[20px] tracking-[-0.2px] w-full">
        <p className="leading-[28px]">How do I change my enterprise payment method?</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[14px] w-full">
        <p className="leading-[20px]">{`To update your payment credentials, navigate to Settings > Billing and select 'Edit Payment Method'. All major…`}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[10.5px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="10.5" preserveAspectRatio="none" viewBox="0 0 10.5 10.5" width="10.5">
        <g id="Container">
          <path d={svgPaths.p1c1607c0} fill="var(--fill-0, #434656)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[12px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[16px]">Last Edited: 2 days ago</p>
      </div>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="relative shrink-0 size-[18px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 18 18" width="18">
        <g id="Container">
          <path d={svgPaths.pad10a80} fill="var(--fill-0, #003EC7)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button3() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center pb-[14px] pt-[8px] px-[8px] relative rounded-[8px] shrink-0" data-name="Button">
      <Container51 />
    </div>
  );
}
  ...
  return (
    <div className="h-[15px] relative shrink-0 w-[22px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="15" preserveAspectRatio="none" viewBox="0 0 22 15" width="22">
        <g id="Container">
          <path d={svgPaths.p3e801e80} fill="var(--fill-0, #434656)" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[18px] relative shrink-0 w-[16px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="18" preserveAspectRatio="none" viewBox="0 0 16 18" width="16">
        <g id="Container">
          <path d={svgPaths.p2780bd80} fill="var(--fill-0, #BA1A1A)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function FaqItem() {
  return (
    <div className="relative shrink-0 w-full" data-name="FAQ Item 1">
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[20px] tracking-[-0.2px] w-full">
        <p className="leading-[28px]">Where can I download my annual tax invoices?</p>
      </div>
    </div>
  );
}
...
function Container55() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[14px] w-full">
        <p className="leading-[20px]">Annual tax invoices are generated automatically on January 1st and can be found in the Documents tab of the…</p>
      </div>
    </div>
  );
}
...
function FaqItem1() {
  return (
    <div className="relative shrink-0 w-full" data-name="FAQ Item 2">
      <div aria-hidden className="absolute border-[rgba(195,197,217,0.2)] border-solid border-t inset-0 pointer-events-none" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[24px] items-start pb-[24px] pt-[25px] px-[24px] relative size-full">
        <Container54 />
        <Container60 />
      </div>
    </div>
...
function BackgroundBorderShadow() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Background+Border+Shadow">
      ...
      <div aria-hidden className="absolute border border-[rgba(195,197,217,0.3)] border-solid inset-0 pointer-events-none shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
}

function SectionCategoryBilling() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Section - Category: Billing">
      <Container42 />
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[20px] tracking-[-0.2px] whitespace-nowrap">
        <p className="leading-[28px]">How does the Smart Tagging system work?</p>
      </div>
    </div>
  );
}
...
function Container67() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[14px] w-full">
        <p className="leading-[20px]">Our neural engine analyzes the content of your FAQ and automatically applies taxonomy tags to improve search…</p>
      </div>
    </div>
  );
}
...
function SectionCategoryAiCapabilities() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Section - Category: AI Capabilities">
...
function Heading6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#191b25] text-[20px] tracking-[-0.2px] w-full">
        <p className="leading-[28px]">What are the rate limits for the Public API?</p>
      </div>
    </div>
  );
}
...
function Container78() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#434656] text-[14px] w-full">
        <p className="leading-[20px]">Standard enterprise accounts are limited to 10,000 requests per minute. For higher throughput, please contact…</p>
      </div>
    </div>
  );
}
...
function Container85() {
  return (
    <div className="h-[19.8px] relative shrink-0 w-[22px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="19.8" preserveAspectRatio="none" viewBox="0 0 22 19.8" width="22">
        <g id="Container">
          <path d={svgPaths.p20809060} fill="var(--fill-0, #434656)" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Button13() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center opacity-40 pb-[14px] pt-[8px] px-[8px] relative rounded-[8px] shrink-0" data-name="Button">
      <Container85 />
    </div>
  );
}
...
function SectionCategoryConnectivity() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Section - Category: Connectivity">
...
function FaqListSection() {
  return (
    <div className="content-stretch flex flex-col h-[705.667px] items-start relative shrink-0 w-full" data-name="FAQ List Section">
      <SectionCategoryBilling />
      <SectionCategoryAiCapabilities />
      <SectionCategoryConnectivity />
    </div>
  );
}
...
function PageCanvas() {
  return (
    <div className="max-w-[1280px] relative shrink-0 w-full z-[1]" data-name="Page Canvas">
      <div className="content-stretch flex flex-col gap-[40px] items-start max-w-[inherit] px-[32px] py-[40px] relative size-full">
        <Nav1 />
        <HeaderSection />
        <FaqListSection />
      </div>
...
function MainContentShell() {
  return (
    <div className="content-stretch flex flex-col isolate items-start min-h-[1024px] relative shrink-0 w-full" data-name="Main Content Shell">
...
export default function FaqEditor() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[256px] relative size-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(251, 248, 255) 0%, rgb(251, 248, 255) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="FAQ Editor">
